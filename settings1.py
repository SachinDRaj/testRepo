...
ALLOWED_HOSTS = ['localhost','64.28.140.201','django'] if os.getenv('ALLOWED_HOSTS') is None \
...
GEOSERVER_LOCATION = os.getenv(
	'GEOSERVER_LOCATION','http://64.28.140.201/geoserver/'
)
...
OGC_SERVER_DEFAULT_PASSWORD = os.getenv(
	'GEOSERVER_DEFAULT_PASSWORD','agrinettpassword'
)
